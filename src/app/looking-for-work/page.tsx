...
const PHONE_DISPLAY = '(404) 737-9453';
const PHONE_HREF = 'tel:+14047379453';

export const metadata: Metadata = {
  title: 'Looking for Work',
  description:
    "Looking for home organizing work in Atlanta? Local organizing companies are hiring. Fill out the quick form and we'll connect you — or call (404) 737-9453.",
  alternates: { canonical: 'https://homeorganizersatlanta.com/looking-for-work' },
};
    ...
    <>
      <section className="bg-gray-900 text-white">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-wide text-teal-300">Looking for Work?</p>
          <h1 className="mt-3 text-4xl font-bold tracking-tight text-white sm:text-5xl">
            Home Organizing Work in Atlanta
          </h1>
          <p className="mt-5 max-w-3xl text-lg text-gray-300">
            Local home organizing companies are growing and looking for dependable people. Tell us
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#work-form"
              className="inline-block rounded-lg bg-teal-600 px-7 py-3 font-semibold text-white hover:bg-teal-700 transition-colors"
            >
              Fill Out the Quick Form
            </a>
            <a
              href={PHONE_HREF}
              className="inline-block rounded-lg border-2 border-teal-400 px-7 py-3 font-semibold text-teal-300 hover:bg-teal-400/10 transition-colors"
            >
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-8 md:grid-cols-3">
          {STEPS.map((s) => (
            <div key={s.n} className="rounded-3xl bg-teal-50 p-8 text-center">
              <span className="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-teal-600 text-lg font-bold text-white">
                {s.n}
              </span>
      ...
      <section className="bg-white/60 border-y border-gray-200">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-center text-gray-600 max-w-2xl mx-auto">
            Organizing businesses in Atlanta and the surrounding area hire for a range of work,
            including:
          </p>
