...
export const metadata: Metadata = {
  title: 'Leave a Review | Home Organizers Atlanta',
  description: 'Leave Home Organizers Atlanta a review on Google or Yelp.',
};

const reviews = [
  {
    label: 'Leave a Google Review',
    href: 'https://g.page/r/CeeQzldhIerXEAE/review',
    kind: 'google',
  },
  {
    label: 'Leave a Yelp Review',
    href: 'https://www.yelp.com/biz/atlanta-home-organizers-atlanta',
    kind: 'yelp',
  },
];
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        <p className="mb-10 text-gray-600">
          Your feedback helps others find Home Organizers Atlanta and helps us
          keep improving.
        </p>
